...
class TestPage extends StatefulWidget {
  TestPage({Key key, this.label}) : super(key: key);
  ...
  // case the label) provided by the parent (in this case the App widget) and
...
//        // the App.build method, and use it to set our appbar label.
